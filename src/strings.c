...
const u8 gText_BattleStyle[] = _("MODES ENABLED");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MID");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FAST");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INST");
...
const u8 gText_ChallengeMode[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}EXPERT");
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SET");
const u8 gText_NuzlockeMode[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NUZLOCKE");
