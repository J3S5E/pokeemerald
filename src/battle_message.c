...
const u8 gText_MoveInterfacePower[] = _("POWER ");
const u8 gText_MoveInterfacePhys[] = _("PHYSICAL");
const u8 gText_MoveInterfaceSpec[] = _("SPECIAL");
const u8 gText_MoveInterfaceStat[] = _("STATUS");
const u8 gText_MoveInterfaceAcc[] = _("ACCURACY ");
const u8 gText_MoveInterfaceBlank[] = _("   ---");
const u8 gText_MoveInterfaceBlankAcc[] = _("ACCURACY ---");
