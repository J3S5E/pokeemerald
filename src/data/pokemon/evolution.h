const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
   ...
   // [SPECIES_PIDGEOT]	 = {{EVO_MEGA_EVOLUTION, ITEM_NONE,/*ITEM_PIDGEOTITE*/ SPECIES_MEGA_PIDGEOT}},
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                            {EVO_ITEM_HOLD_DAY, ITEM_THUNDER_STONE, SPECIES_RAICHU}},
    ...
    [SPECIES_NIDORINA]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOQUEEN},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_MOON_STONE, SPECIES_NIDOQUEEN},
                            {EVO_ITEM_HOLD_DAY, ITEM_MOON_STONE, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDOKING},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_MOON_STONE, SPECIES_NIDOKING},
                            {EVO_ITEM_HOLD_DAY, ITEM_MOON_STONE, SPECIES_NIDOKING}},
    [SPECIES_CLEFAIRY]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_CLEFABLE},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_MOON_STONE, SPECIES_CLEFABLE},
                            {EVO_ITEM_HOLD_DAY, ITEM_MOON_STONE, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]     = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_FIRE_STONE, SPECIES_NINETALES},
                            {EVO_ITEM_HOLD_DAY, ITEM_FIRE_STONE, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF},
                            {EVO_ITEM_HOLD_DAY, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF}},
    ...
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                            {EVO_ITEM_HOLD_DAY, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BELLOSSOM},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_SUN_STONE, SPECIES_BELLOSSOM},
                            {EVO_ITEM_HOLD_DAY, ITEM_SUN_STONE, SPECIES_BELLOSSOM}},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_FIRE_STONE, SPECIES_ARCANINE},
                            {EVO_ITEM_HOLD_DAY, ITEM_FIRE_STONE, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 25, SPECIES_POLIWHIRL}},
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM_HOLD_DAY, ITEM_WATER_STONE, SPECIES_POLIWRATH},
    ...
    [SPECIES_MACHOKE]	 = {{EVO_TRADE, 0, SPECIES_MACHAMP},
                            {EVO_LEVEL, 48, SPECIES_MACHAMP}},
    [SPECIES_BELLSPROUT] = {{EVO_LEVEL, 21, SPECIES_WEEPINBELL}},
    [SPECIES_WEEPINBELL] = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VICTREEBEL},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_LEAF_STONE, SPECIES_VICTREEBEL},
                            {EVO_ITEM_HOLD_DAY, ITEM_LEAF_STONE, SPECIES_VICTREEBEL}},
    ...
    [SPECIES_MAGNETON]	 = {{EVO_MAP, 62, SPECIES_MAGNEZONE},
                            ...
                            {EVO_ITEM_HOLD_DAY, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE}},
