...
#define TUTOR_MOVE_AIR_CUTTER     0 
#define TUTOR_MOVE_ANCIENT_POWER  1 
#define TUTOR_MOVE_AQUA_TAIL  2 
#define TUTOR_MOVE_BLAST_BURN  3 
#define TUTOR_MOVE_BLOCK  4 
#define TUTOR_MOVE_BODY_SLAM  5 
#define TUTOR_MOVE_BOUNCE  6 
#define TUTOR_MOVE_BUG_BITE  7 
#define TUTOR_MOVE_COUNTER  8 
#define TUTOR_MOVE_DEFENSE_CURL  9 
#define TUTOR_MOVE_DOUBLE_EDGE  10
#define TUTOR_MOVE_DRACO_METEOR  11
#define TUTOR_MOVE_DREAM_EATER  12
#define TUTOR_MOVE_DYNAMIC_PUNCH  13
#define TUTOR_MOVE_EARTH_POWER  14
#define TUTOR_MOVE_ENDEAVOR  15
#define TUTOR_MOVE_ENDURE  16
#define TUTOR_MOVE_EXPLOSION  17
#define TUTOR_MOVE_FIRE_PUNCH  18
#define TUTOR_MOVE_FRENZY_PLANT  19
#define TUTOR_MOVE_FURY_CUTTER  20
#define TUTOR_MOVE_GASTRO_ACID  21
#define TUTOR_MOVE_GRAVITY  22
#define TUTOR_MOVE_GUNK_SHOT  23
#define TUTOR_MOVE_HEADBUTT  24
#define TUTOR_MOVE_HEAL_BELL  25
#define TUTOR_MOVE_HEAT_WAVE  26
#define TUTOR_MOVE_HELPING_HAND  27
#define TUTOR_MOVE_HYDRO_CANNON  28
#define TUTOR_MOVE_ICE_PUNCH  29
#define TUTOR_MOVE_ICY_WIND  30
#define TUTOR_MOVE_IRON_DEFENSE  31
#define TUTOR_MOVE_IRON_HEAD  32
#define TUTOR_MOVE_KNOCK_OFF  33
#define TUTOR_MOVE_LAST_RESORT  34
#define TUTOR_MOVE_LOW_KICK  35
#define TUTOR_MOVE_MAGIC_COAT  36
#define TUTOR_MOVE_MAGNET_RISE  37
#define TUTOR_MOVE_MEGA_KICK  38
#define TUTOR_MOVE_MEGA_PUNCH  39
#define TUTOR_MOVE_METRONOME  40
#define TUTOR_MOVE_MIMIC  41
#define TUTOR_MOVE_MUD_SLAP  42
#define TUTOR_MOVE_OMINOUS_WIND  43
#define TUTOR_MOVE_OUTRAGE  44
#define TUTOR_MOVE_PAIN_SPLIT  45
#define TUTOR_MOVE_PSYCH_UP  46
#define TUTOR_MOVE_ROCK_SLIDE  47
#define TUTOR_MOVE_ROLE_PLAY  48
#define TUTOR_MOVE_ROLLOUT  49
#define TUTOR_MOVE_SEED_BOMB  50
#define TUTOR_MOVE_SEISMIC_TOSS  51
#define TUTOR_MOVE_SIGNAL_BEAM  52
#define TUTOR_MOVE_SKY_ATTACK  53
#define TUTOR_MOVE_SLEEP_TALK  54
#define TUTOR_MOVE_SNORE  55
#define TUTOR_MOVE_SOFT_BOILED  56
#define TUTOR_MOVE_SPITE  57
#define TUTOR_MOVE_STRING_SHOT  58
#define TUTOR_MOVE_SUBSTITUTE  59
#define TUTOR_MOVE_SUCKER_PUNCH  60
#define TUTOR_MOVE_SUPERPOWER  61
#define TUTOR_MOVE_SUPER_FANG  62
#define TUTOR_MOVE_SWAGGER  63
#define TUTOR_MOVE_SWIFT  64
#define TUTOR_MOVE_SWORDS_DANCE  65
#define TUTOR_MOVE_SYNTHESIS  66
#define TUTOR_MOVE_TAILWIND  67
#define TUTOR_MOVE_THUNDER_PUNCH  68
#define TUTOR_MOVE_THUNDER_WAVE  69
#define TUTOR_MOVE_TRICK  70
#define TUTOR_MOVE_TWISTER  71
#define TUTOR_MOVE_UPROAR  72
#define TUTOR_MOVE_VACUUM_WAVE  73
#define TUTOR_MOVE_WORRY_SEED  74
#define TUTOR_MOVE_ZEN_HEADBUTT  75
#define TUTOR_MOVE_COUNT           76
