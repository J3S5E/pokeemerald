...
extern const u8 gText_MoveInterfaceBlank[];
extern const u8 gText_MoveInterfacePower[];
extern const u8 gText_MoveInterfacePhys[];
extern const u8 gText_MoveInterfaceSpec[];
extern const u8 gText_MoveInterfaceStat[];
extern const u8 gText_MoveInterfaceAcc[];
extern const u8 gText_MoveInterfaceBlankAcc[];
